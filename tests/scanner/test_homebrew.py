...
def test_list_formulae_returns_list() -> None:
    scanner = HomebrewScanner()
...
def test_list_casks_returns_list() -> None:
    scanner = HomebrewScanner()
...
def test_get_package_info_empty_dict() -> None:
    scanner = HomebrewScanner()
...
def test_get_outdated_packages_returns_list() -> None:
    scanner = HomebrewScanner()
...
def test_calculate_package_size_returns_zero_for_missing_path() -> None:
    scanner = HomebrewScanner()
...
def test_get_total_size_returns_zero() -> None:
    scanner = HomebrewScanner()
